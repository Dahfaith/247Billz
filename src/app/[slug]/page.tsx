  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0F172A] selection:bg-[#F97316]/30">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        <div className="mb-6">
          <Link href="/" className="inline-flex items-center gap-2 text-sm font-medium text-[#64748B] hover:text-[#F97316] transition-colors bg-white dark:bg-[#1E293B] px-4 py-2 rounded-lg border border-[#E2E8F0] dark:border-slate-800 shadow-sm">
